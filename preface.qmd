...
- How we do study generalization ability of such binary networks? and from a _build_ point of view, what is needed to generalize? I hypothesize that _smoothness_ of the functions is central to generalization. So, how do we define and later enforce such smoothness of Boolean Networks. 
